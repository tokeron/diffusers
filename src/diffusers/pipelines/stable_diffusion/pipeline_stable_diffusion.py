...
class StableDiffusionPipeline(
    ...
    def encode_prompt(
        ...
        Args:
            ...
            skip_tokens (`List[int]`, *optional*):
                List of token indices to be replaced with padding tokens. This is useful for generating images with
                specific tokens replaced with padding tokens.
        """
        ...
        if prompt_embeds is None:
            ...
            if clip_skip is None:
                ...
                # prompt_embeds = text_encoder_output.hidden_states[-1][-1]
                # prompt_embeds = self.text_encoder.text_model.final_layer_norm(prompt_embeds)
                ...
                prompt_embeds = text_encoder_output.hidden_states[-(clip_skip + 1)]
            ...
            if skip_tokens is not None:
                ...
                if pad_str is None:
                    pad_str = self.tokenizer.pad_token # 'An amazing image, 4K, high quality, visually stunning and beautiful.' #
                print('pad_str: ', pad_str)
                padding_tokenized= self.tokenizer([pad_str],
                                                  return_tensors="pt",
                                                  padding="max_length",
                                                  max_length=self.tokenizer.model_max_length)
                ...
                print("padding_attention_mask: ", padding_attention_mask)
                text_encoder_output_paddings = self.text_encoder(padding_input_ids.to(device), output_hidden_states=True,
    ...
    def skip_tokens(self):
        return self._skip_tokens

    @property
    def pad_str(self):
        return self._pad_str
        ...
        **kwargs,
        ...
        Args:
            ...
            clip_skip (`int`, *optional*):
                ...
                the output of the pre-final layer will be used for computing the prompt embeddings.
            skip_tokens (`List[int]`, *optional*):
                List of token indices to be skipped while generating the image. The skipped tokens will be replaced by
                encoded padding tokens. 
